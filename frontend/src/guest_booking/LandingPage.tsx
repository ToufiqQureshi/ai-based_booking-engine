...
export default function LandingPage() {
    ...
    return (
        <div className="landing-page-container bg-[#0A0505] text-white overflow-x-hidden">
                ...
                <div className="lg:col-span-7 flex justify-center order-1 lg:order-2 reveal-up">
                    <div className="w-full max-w-[500px] glass-panel rounded-2xl p-4 sm:p-6 border border-white/10 shadow-2xl relative text-center space-y-4">
                        ...
                        <div className="h-20 flex items-center justify-center gap-1.5 py-4">
                            <span className="w-1.5 h-6 bg-accentCyan rounded-full animate-bounce" style={{animationDelay: '0.1s'}}></span>
                            <span className="w-1.5 h-12 bg-accentCyan rounded-full animate-bounce" style={{animationDelay: '0.2s'}}></span>
                            <span className="w-1.5 h-16 bg-accentCyan rounded-full animate-bounce" style={{animationDelay: '0.3s'}}></span>
                            <span className="w-1.5 h-8 bg-accentCyan rounded-full animate-bounce" style={{animationDelay: '0.4s'}}></span>
                            <span className="w-1.5 h-14 bg-accentCyan rounded-full animate-bounce" style={{animationDelay: '0.5s'}}></span>
                        </div>
