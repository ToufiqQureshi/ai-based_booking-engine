                    ...
                    <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-4 lg:gap-6 bg-slate-50/50 p-3 lg:p-4 rounded-3xl border border-slate-100">
                        ...
                        <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
                            ...
                            <PopoverContent className="w-auto p-6 bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden max-w-[95vw]" align="start">
                                ...
                                />
                                <div className="border-t border-slate-100 pt-4 mt-6 text-center text-xs text-slate-500 flex items-center justify-center gap-2 font-bold tracking-wide">
                        ...
                        <div className="bg-slate-50/80 backdrop-blur-sm p-4 rounded-2xl border border-slate-100 flex items-center justify-between gap-3 w-full">
                            <div className="min-w-0 flex-1">
                                ...
                                {selectedAddons.length > 0 ? (
                                    ...
                                    <p className="text-[11px] font-medium text-slate-400 mt-0.5 truncate">No optional add-ons selected</p>
                                )}
                            </div>
